...
class SearchController extends Controller
{
    ...
    private function pageIndex(): array
    {
        return [
            ...
            ['title' => 'Reports',         'subtitle' => 'Daily breakdown of pay',         'url' => route('payroll-records'),                   'keywords' => 'payroll reports payslip pay period weekly daily salary records gross net deductions overtime bonus receipt'],
