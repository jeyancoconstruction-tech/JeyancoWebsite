...
class SearchController extends Controller
{
    ...
    private function pageIndex(): array
    {
        return [
            ...
            ['title' => 'Payroll Settings', 'subtitle' => 'Multipliers, deductions, labor, holidays', 'url' => route('settings.index'),                    'keywords' => 'settings config sss philhealth pagibig overtime bonus holiday labor rate multiplier'],
        ];
    }
}
