...
@include('system._kit')
<style>
.ap { display: grid; grid-template-columns: repeat(3, minmax(0, 230px)); gap: 16px; padding: 16px 18px 6px; }
...
.ap-mini { height: 118px; border-radius: 8px; overflow: hidden; border: 1px solid var(--border); position: relative; }
