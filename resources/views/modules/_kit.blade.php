...
/* A list boxed to the screen carries data-fill-screen on its card; the rules
   that size it, and the script that measures it, live in
   modules/_fill_screen.blade.php, which such a page includes. */
